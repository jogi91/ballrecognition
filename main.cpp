...
//Schiesst, wartet delay millisekunden, und lässt dann wieder los, und das alles mit den gewünschten Flipperfingern
...
//case 1 ff. sind dazu gedacht, von ausgelösten Flippern Referenzbilder zu schiessen.
...
//Signalhandler für das Beenden durch den Nutzer
		...
		IplImage *workingcopy = cvCreateImage(cvSize(width, height), 8, 1);
			...
			while (1) {
				...
				if (circles->total < 10 and circles->total != 0 and counter > 6) {
					...
					//eingefügt, um zu prüfen, ob das gleiche Bild evtl. mehrmals ausgewertet wird.
